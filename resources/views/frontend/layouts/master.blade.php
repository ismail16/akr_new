                            ...
                            <div class="top_left_sidebar left_sidebar_two">
                                ...
                                <div class="switcher switcher_two">
                                    <ul>
                                        ...
                                        <li class="languages"><a href="#"><img src="{{ asset('frontend_assets/assets/img/logo/lion.jpg')}}" alt=""> English <i class="fa fa-angle-down"></i></a>
                                            <ul class="dropdown_languages">
                                                <li class="select"><img src="{{ asset('frontend_assets/assets/img/logo/lion.jpg')}}" alt=""> English</li>
                                                <li><a href="#" title="اللغة العربية (Arabic)"><img src="{{ asset('frontend_assets/assets/img/logo/lion1.jpg')}}" alt=""> اللغة العربية </a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
...
<!-- Mirrored from demo.devitems.com/lion-v2/lion/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jul 2019 10:22:07 GMT -->
</html>
